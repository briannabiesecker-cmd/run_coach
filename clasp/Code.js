...
function buildSystemPrompt(style) {
  ...
  return [
    ...
    '- Days are Mon-Sun. Each day: type (Easy/Long/Tempo/Intervals/Hill Repeats/Strides/Rest/Cross), miles, short description.',
    '',
    ...
    '        {"day": "Tue", "type": "Easy", "miles": 4, "note": "Easy pace + 4 strides at end"},',
